...
namespace CONTACTO_TEST.Unit
{
    public class ContactoServiceTests
    {
        ...
        public void Obtener_ConContactos_RetornaLista()
        {
            ...
            _repoMock.Setup(x => x.ObtenerTodos())
                .Returns(contactos);
        ...
        public void ObtenerPorId_Existe_RetornaSuccess()
        {
            ...
            _repoMock.Setup(x => x.ObtenerPorId(1))
                .Returns(contacto);
        ...
        {
            _repoMock.Setup(x => x.ObtenerPorId(99))
        ...
        [Fact]
        public void Crear_TelefonoNuevo_RetornaContacto()
        {
            var request = new CrearContactoRequest
            {
                Nombre = "Paola Pina",
                Telefono = "123456789"
            };
            ...
            _repoMock.Setup(x => x.ExisteTelefono("123456789"))
                .Returns(false);

            _repoMock.Setup(x => x.Agregar("Paola Pina", "123456789"))
                .Returns(contacto);
        ...
        public void Crear_TelefonoDuplicado_RetornaConflict()
        {
            ...
            _repoMock
                .Setup(x => x.ExisteTelefono("123456789"))
                .Returns(true);
            ...
            _repoMock.Verify(
                x => x.Agregar(It.IsAny<string>(), It.IsAny<string>()),
                Times.Never
            );
        }
    }
